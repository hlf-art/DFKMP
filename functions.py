...
def comp_simi(inputs):
	...
	thres = 0.9
	# print('9999999999999999',values)
	# print('8888888888888888',indices)
...
# 	inputs2 = torch.mul(inputs, inputs)
# 	norm2 = torch.sum(inputs2, 1)
# 	root_inv = torch.rsqrt(norm2)##归一化memership
#
# 	center2 = torch.mul(center, center)
# 	norm22 = torch.sum(center2, 1)
# 	root_inv2 = torch.rsqrt(norm22)##归一化center
#
# 	tmp_var1 = root_inv.expand(dim,batch_size)
# 	tmp_var2 = torch.t(tmp_var1)
# 	tmp_var11= root_inv2.expand(dim1,batch_size1)
# 	tmp_var22 = torch.t(tmp_var11)
#
# 	nml_inputs = torch.mul(inputs, tmp_var2)
# 	nml_inputs2 = torch.mul(center, tmp_var22)
#
# 	nml_inputs2 = nml_inputs2.float()
# 	similarity = torch.matmul(nml_inputs, nml_inputs2)
# 	# similarity2 = similarity - torch.eye(batch_size).cuda()
# 	return similarity, one_hot_labels, weights
